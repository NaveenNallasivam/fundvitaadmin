...
@Entity
@Table(name = "FUND_STOCK_PB")
public class StockPbImpl implements com.example.fundvitaadmin.entity.StockPb, Serializable {
    ...
    public StockPbImpl(Long uidpk, StockImpl stock, BigDecimal value) {
        this.uidpk = uidpk;
        this.stock = stock;
        this.value = value;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof StockPbImpl)) return false;
        StockPbImpl that = (StockPbImpl) o;
